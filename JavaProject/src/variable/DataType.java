...
public class DataType {
	...
	public static void main(String[] args) {
		// 정수타입 : 기본 타입 int, long 형은 기본타입이 아니기 때문에 리터럴 뒤에 l / L도 추가해야 함
		int four = 100; //4byte
		long fourD = 100; // 8byte
		
		// 1000100010001000 4byte로도 표현 불가능한 가중치의 정수임 -4byte로 표현하려고 해서 오류가 발생
		...
		float floatValue = 0.123456789012345679f;
