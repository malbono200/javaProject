...
public class ArrayInfo {
	...
	public static void main(String[] args) {
		...
		double num2[] = {5.0,6.5};
		String[] nation = {"Korea","Japan", "chinal"};
		...
		// 가상주소가 [로 시작하면, 배열임, [ : 1차원 배열 [[ : 2차원 배열
		...
		// length 속성은 final field이기 때문에 수정 불가능 함
		//num3.length = 10;
		
		//배열길이를 변경하려면 기존 배열 길이 변경은 불가능 함
		//더 큰 배열 생성하고, 기준 배열 내용을 새로운 배열에 복사해서 사용해야 함
		...
		//배열변수 출력 : 배열의 가상주소
		//배열변수 toString() 활용 - 문자열 반환(참조형 객체인 경우에는 참조하는 데이터를 문자열로 반환)
