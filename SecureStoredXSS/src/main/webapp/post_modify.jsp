    ...
    try
    {
        ...
        {%>
            ...
            <table border="1">
                <tr>
                    <td>작성자</td>
                    <td><input type="text" name="writer" value="<c:out value="<%=result.getString(\"writer\")%>"/>"></td>
                </tr>
                <tr>
                    <td>제목</td>
                    <td><input type="text" name="title" value="<c:out value="<%=result.getString(\"title\")%>"/>"></td>
                </tr>
                <tr>
                    <td>내용</td>
                    <td><textarea rows="10" cols="20" name="content"><c:out value="<%=result.getString(\"content\")%>"/></textarea>
                </tr>
                <tr>
                    <td colspan="2">
