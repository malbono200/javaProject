...
<html>
	...
	<body>
		...
		<jsp:setProperty property="stdName" name= "student" value=""/>
		...
		<h3>빈 속성값 설정</h3>
		<jsp:setProperty property= "stdNo" name="student" value="2026001"/>
		<jsp:setProperty property= "stdName" name= "student" value="25"/>
		<jsp:setProperty property="stdPhone" name= "student" value="010-1234-1234"/>
		<jsp:setProperty property="stdAddress" name= "student" value="X|"/>
		<jsp:setProperty property= "stdYear" name= "student" value="4"/>
